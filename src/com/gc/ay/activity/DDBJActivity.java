...
public class DDBJActivity extends SuperActivity implements OnClickListener {

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_ddbj);
		init();
	}
	...
	public void onClick(View v) {
		// TODO
		demoDialog = DialogUtil.createConfirmDialog(getApplicationContext(),
				"DemoDialog", "确定取消对话框", new GcDialogOnClickListener() {
		...
		demoDialog.setCanceledOnTouchOutside(false);// 触摸边缘不可关闭
		demoDialog.show();
	}
